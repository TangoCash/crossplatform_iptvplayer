...
# all other work is (c) E2iStream Team, aka Codermik.  TSiPlayer is (c) Rgysoft, his group can be
...
class LookMovieag(CBaseHostClass):
            ...
            try:
                ...
                for items in block:
                    ...
                    if '<div class="quality-tag tooltip">' in items:
                        ...
                        quality = ''
                        if '/shows/' in tmpurl:
                            tooltip = '720p Quality'
                        else:
                            tooltip = 'No quality has been specified.'
    ...
    def listSearchResult(self, cItem, searchPattern, searchType):
        ...
        elif searchType == 'tvseries':
            cItem['url'] = self.getFullUrl('/shows/search/?q=') + urllib.quote(searchPattern)
